#include "subghz_wardiving_frequency_analyzer.h"

#include <furi.h>
#include <input/input.h>
#include <notification/notification_messages.h>
#include <gui/elements.h>
#include "../helpers/subghz_wardiving_frequency_analyzer_worker.h"
            ...
            SubGhzFrequencyAnalyzerModel * model,
            {
                ...
                frequency_candidate =
                    frequency_candidate == 0 ||
                            !subghz_wardiving_txrx_radio_device_is_frequency_valid(
...
void subghz_frequency_analyzer_enter(void* context) {
    ...
    with_view_model(
        ...
        SubGhzFrequencyAnalyzerModel * model,
        {
            ...
            model->is_ext_radio =
                (subghz_wardiving_txrx_radio_device_get(instance->txrx) !=
...
SubGhzFrequencyAnalyzer* subghz_frequency_analyzer_alloc(SubGhzTxRxWarDiving* txrx) {
