...
#include "../helpers/subghz_wardiving_txrx_create_protocol_key.h"
#include "../helpers/subghz_wardiving_gen_info.h"
#include "subghz_wardiving_scene_start.h"
...
bool subghz_scene_set_type_generate_protocol_from_infos(SubGhz* subghz) {
    ...
    case GenData:
        if(gen_info.data.te) {
            generated_protocol = subghz_wardiving_txrx_gen_data_protocol_and_te(
                subghz->txrx,
                gen_info.mod,
                gen_info.freq,
                gen_info.data.name,
            ...
            generated_protocol = subghz_wardiving_txrx_gen_data_protocol(
                subghz->txrx,
                gen_info.mod,
                gen_info.freq,
                gen_info.data.name,
        ...
        break;
    case GenFaacSLH:
        generated_protocol = subghz_wardiving_txrx_gen_faac_slh_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenKeeloq:
        generated_protocol = subghz_wardiving_txrx_gen_keeloq_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenCameAtomo:
        generated_protocol = subghz_wardiving_txrx_gen_came_atomo_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenKeeloqBFT:
        generated_protocol = subghz_wardiving_txrx_gen_keeloq_bft_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenAlutechAt4n:
        generated_protocol = subghz_wardiving_txrx_gen_alutech_at_4n_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenSomfyTelis:
        generated_protocol = subghz_wardiving_txrx_gen_somfy_telis_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenSomfyKeytis:
        generated_protocol = subghz_wardiving_txrx_gen_somfy_keytis_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
    ...
    case GenKingGatesStylo4k:
        generated_protocol = subghz_wardiving_txrx_gen_kinggates_stylo_4k_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenBenincaARC:
        generated_protocol = subghz_wardiving_txrx_gen_beninca_arc_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenJarolift:
        generated_protocol = subghz_wardiving_txrx_gen_jarolift_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenDitecGOL4:
        generated_protocol = subghz_wardiving_txrx_gen_ditec_gol4_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenNiceFlorS:
        generated_protocol = subghz_wardiving_txrx_gen_nice_flor_s_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenSecPlus1:
        generated_protocol = subghz_wardiving_txrx_gen_secplus_v1_protocol(
            subghz->txrx, gen_info.mod, gen_info.freq);
        break;
    case GenSecPlus2:
        generated_protocol = subghz_wardiving_txrx_gen_secplus_v2_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
        ...
        break;
    case GenPhoenixV2:
        generated_protocol = subghz_wardiving_txrx_gen_phoenix_v2_protocol(
            subghz->txrx,
            gen_info.mod,
            gen_info.freq,
