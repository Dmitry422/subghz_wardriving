#include "subghz_wardiving_txrx_i.h" // IWYU pragma: keep
...
static void subghz_wardiving_txrx_radio_device_power_on(SubGhzTxRxWarDiving* instance) {
    UNUSED(instance);
...
static void subghz_wardiving_txrx_radio_device_power_off(SubGhzTxRxWarDiving* instance) {
    UNUSED(instance);
    Power* power = furi_record_open(RECORD_POWER);
...
SubGhzTxRxWarDiving* subghz_wardiving_txrx_alloc(void) {
    ...
    subghz_wardiving_txrx_set_default_preset(instance, 0);

    instance->txrx_state = SubGhzTxRxStateSleep;

    subghz_wardiving_txrx_hopper_set_state(instance, SubGhzHopperStateOFF);
    subghz_wardiving_txrx_speaker_set_state(instance, SubGhzSpeakerStateDisable);
    subghz_wardiving_txrx_set_debug_pin_state(instance, false);
    ...
    instance->radio_device_type =
        subghz_wardiving_txrx_radio_device_set(instance, SubGhzRadioDeviceTypeExternalCC1101);

    return instance;
}

void subghz_wardiving_txrx_free(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);

    if(instance->radio_device_type != SubGhzRadioDeviceTypeInternal) {
        subghz_wardiving_txrx_radio_device_power_off(instance);
...
bool subghz_wardiving_txrx_is_database_loaded(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->is_database_loaded;
}

void subghz_wardiving_txrx_set_preset(
...
uint8_t* subghz_wardiving_txrx_set_tx_power(
    uint8_t* preset_data,
    size_t preset_data_size,
    uint8_t tx_power) {
...
const char*
    subghz_wardiving_txrx_get_preset_name(SubGhzTxRxWarDiving* instance, const char* preset) {
    UNUSED(instance);
    const char* preset_name = "";
...
SubGhzRadioPreset subghz_wardiving_txrx_get_preset(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return *instance->preset;
}

void subghz_wardiving_txrx_get_frequency_and_modulation(
    SubGhzTxRxWarDiving* instance,
...
float subghz_wardiving_txrx_get_latitude(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->latitude;
}

float subghz_wardiving_txrx_get_longitude(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->longitude;
}

static void subghz_wardiving_txrx_begin(SubGhzTxRxWarDiving* instance, uint8_t* preset_data) {
    furi_assert(instance);
...
static uint32_t subghz_wardiving_txrx_rx(SubGhzTxRxWarDiving* instance, uint32_t frequency) {
    furi_assert(instance);
    furi_assert(
    ...
    subghz_wardiving_txrx_speaker_on(instance);
...
static void subghz_wardiving_txrx_idle(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    if(instance->txrx_state != SubGhzTxRxStateSleep) {
        subghz_devices_idle(instance->radio_device);
        subghz_wardiving_txrx_speaker_off(instance);
        instance->txrx_state = SubGhzTxRxStateIDLE;
    }
}

static void subghz_wardiving_txrx_rx_end(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
...
void subghz_wardiving_txrx_sleep(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    subghz_devices_sleep(instance->radio_device);
    instance->txrx_state = SubGhzTxRxStateSleep;
}

static bool subghz_wardiving_txrx_tx(SubGhzTxRxWarDiving* instance, uint32_t frequency) {
    furi_assert(instance);
...
SubGhzTxRxStartTxState
    subghz_wardiving_txrx_tx_start(SubGhzTxRxWarDiving* instance, FlipperFormat* flipper_format) {
    furi_assert(instance);
    furi_assert(flipper_format);

    subghz_wardiving_txrx_stop(instance);
    ...
    do {
            ...
            if(subghz_transmitter_deserialize(instance->transmitter, flipper_format) ==
               SubGhzProtocolStatusOk) {
                if(strcmp(furi_string_get_cstr(preset->name), "") != 0) {
                    subghz_wardiving_txrx_begin(
                        instance,
                        subghz_setting_get_preset_data_by_name(
                            instance->setting, furi_string_get_cstr(preset->name)));
                    if(preset->frequency) {
                        if(!subghz_wardiving_txrx_tx(instance, preset->frequency)) {
        ...
        if(ret != SubGhzTxRxStartTxStateOk) {
            ...
            if(instance->txrx_state != SubGhzTxRxStateIDLE) {
                subghz_wardiving_txrx_idle(instance);
            }
        }
...
void subghz_wardiving_txrx_rx_start(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    subghz_wardiving_txrx_stop(instance);
    subghz_wardiving_txrx_begin(
        instance,
        subghz_setting_get_preset_data_by_name(
            subghz_wardiving_txrx_get_setting(instance),
            furi_string_get_cstr(instance->preset->name)));
    subghz_wardiving_txrx_rx(instance, instance->preset->frequency);
}

void subghz_wardiving_txrx_set_need_save_callback(
    SubGhzTxRxWarDiving* instance,
...
static void subghz_wardiving_txrx_tx_stop(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
...
FlipperFormat* subghz_wardiving_txrx_get_fff_data(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->fff_data;
}

SubGhzSetting* subghz_wardiving_txrx_get_setting(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->setting;
}

void subghz_wardiving_txrx_stop(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);

    switch(instance->txrx_state) {
    case SubGhzTxRxStateTx:
        subghz_wardiving_txrx_tx_stop(instance);
        subghz_wardiving_txrx_speaker_unmute(instance);
        break;
    case SubGhzTxRxStateRx:
        subghz_wardiving_txrx_rx_end(instance);
        subghz_wardiving_txrx_speaker_mute(instance);
        break;
...
void subghz_wardiving_txrx_hopper_update(SubGhzTxRxWarDiving* instance, float stay_threshold) {
    furi_assert(instance);
...
SubGhzHopperState subghz_wardiving_txrx_hopper_get_state(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->hopper_state;
}

void subghz_wardiving_txrx_hopper_set_state(SubGhzTxRxWarDiving* instance, SubGhzHopperState state) {
    furi_assert(instance);
    instance->hopper_state = state;
}

void subghz_wardiving_txrx_hopper_unpause(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
...
void subghz_wardiving_txrx_hopper_pause(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
...
void subghz_wardiving_txrx_speaker_on(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
...
void subghz_wardiving_txrx_speaker_off(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    if(instance->debug_pin_state) {
...
void subghz_wardiving_txrx_speaker_mute(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    if(instance->debug_pin_state) {
        subghz_devices_set_async_mirror_pin(instance->radio_device, NULL);
    }
...
void subghz_wardiving_txrx_speaker_unmute(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    if(instance->debug_pin_state) {
        subghz_devices_set_async_mirror_pin(instance->radio_device, &gpio_ibutton);
    }
...
void subghz_wardiving_txrx_speaker_set_state(
    SubGhzTxRxWarDiving* instance,
...
SubGhzSpeakerState subghz_wardiving_txrx_speaker_get_state(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->speaker_state;
}

bool subghz_wardiving_txrx_load_decoder_by_name_protocol(
    SubGhzTxRxWarDiving* instance,
...
SubGhzProtocolDecoderBase* subghz_wardiving_txrx_get_decoder(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->decoder_result;
}

bool subghz_wardiving_txrx_protocol_is_serializable(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return (instance->decoder_result->protocol->flag & SubGhzProtocolFlag_Save) ==
           SubGhzProtocolFlag_Save;
}

bool subghz_wardiving_txrx_protocol_is_transmittable(
    SubGhzTxRxWarDiving* instance,
    bool check_type) {
    furi_assert(instance);
...
void subghz_wardiving_txrx_receiver_set_filter(
    SubGhzTxRxWarDiving* instance,
...
void subghz_wardiving_txrx_set_rx_callback(
    SubGhzTxRxWarDiving* instance,
...
void subghz_wardiving_txrx_set_raw_file_encoder_worker_callback_end(
    SubGhzTxRxWarDiving* instance,
...
bool subghz_wardiving_txrx_radio_device_is_external_connected(
    SubGhzTxRxWarDiving* instance,
    const char* name) {
    furi_assert(instance);
    ...
    if(!is_otg_enabled) {
        subghz_wardiving_txrx_radio_device_power_on(instance);
    }
...
SubGhzRadioDeviceType subghz_wardiving_txrx_radio_device_set(
    SubGhzTxRxWarDiving* instance,
    SubGhzRadioDeviceType radio_device_type) {
    furi_assert(instance);

    if(radio_device_type == SubGhzRadioDeviceTypeExternalCC1101 &&
       subghz_wardiving_txrx_radio_device_is_external_connected(
...
SubGhzRadioDeviceType subghz_wardiving_txrx_radio_device_get(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->radio_device_type;
}

float subghz_wardiving_txrx_radio_device_get_rssi(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return subghz_devices_get_rssi(instance->radio_device);
}

const char* subghz_wardiving_txrx_radio_device_get_name(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return subghz_devices_get_name(instance->radio_device);
}

bool subghz_wardiving_txrx_radio_device_is_frequency_valid(
    SubGhzTxRxWarDiving* instance,
    uint32_t frequency) {
    furi_assert(instance);
...
bool subghz_wardiving_txrx_radio_device_is_tx_allowed(
    SubGhzTxRxWarDiving* instance,
    uint32_t frequency) {
...
void subghz_wardiving_txrx_set_debug_pin_state(SubGhzTxRxWarDiving* instance, bool state) {
    furi_assert(instance);
    instance->debug_pin_state = state;
}

bool subghz_wardiving_txrx_get_debug_pin_state(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->debug_pin_state;
}

void subghz_wardiving_txrx_reset_dynamic_and_custom_btns(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
...
SubGhzReceiver* subghz_wardiving_txrx_get_receiver(SubGhzTxRxWarDiving* instance) {
    furi_assert(instance);
    return instance->receiver;
}

void subghz_wardiving_txrx_set_default_preset(SubGhzTxRxWarDiving* instance, uint32_t frequency) {
    furi_assert(instance);

    const char* default_modulation = "AM650";
    if(frequency == 0) {
        frequency =
            subghz_setting_get_default_frequency(subghz_wardiving_txrx_get_setting(instance));
    }
    subghz_wardiving_txrx_set_preset(instance, default_modulation, frequency, NAN, NAN, NULL, 0);
}

const char* subghz_wardiving_txrx_set_preset_internal(
    SubGhzTxRxWarDiving* instance,
    uint32_t frequency,
    uint8_t index,
    uint8_t tx_power) {
    ...
    //Grab the prset name.
    SubGhzSetting* setting = subghz_wardiving_txrx_get_setting(instance);
    ...
    subghz_wardiving_txrx_set_tx_power(preset_data, preset_data_size, tx_power);
