...
#include "subghz_wardiving_txrx_create_protocol_key.h"
...
bool subghz_wardiving_txrx_gen_data_protocol(
    void* context,
    ...
    uint32_t bit) {
    furi_assert(context);
    SubGhzTxRxWarDiving* instance = context;

    bool res = false;

    subghz_wardiving_txrx_set_preset(instance, preset_name, frequency, NAN, NAN, NULL, 0);
...
bool subghz_wardiving_txrx_gen_data_protocol_and_te(
    ...
    bool ret = false;
    if(subghz_wardiving_txrx_gen_data_protocol(
           instance, preset_name, frequency, protocol_name, key, bit)) {
...
bool subghz_wardiving_txrx_gen_keeloq_protocol( //TODO lead to a general appearance
    SubGhzTxRxWarDiving* instance,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_keeloq_bft_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
    ...
    uint32_t seed,
    const char* manufacture_name) {
    SubGhzTxRxWarDiving* txrx = context;

    bool res = false;

    txrx->transmitter =
        subghz_transmitter_alloc_init(txrx->environment, SUBGHZ_PROTOCOL_KEELOQ_NAME);
    subghz_wardiving_txrx_set_preset(txrx, preset_name, frequency, NAN, NAN, NULL, 0);
...
bool subghz_wardiving_txrx_gen_nice_flor_s_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_faac_slh_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_alutech_at_4n_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_came_atomo_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_somfy_telis_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_somfy_keytis_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_kinggates_stylo_4k_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_beninca_arc_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_jarolift_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_ditec_gol4_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
bool subghz_wardiving_txrx_gen_secplus_v2_protocol(
    SubGhzTxRxWarDiving* instance,
    ...
    subghz_wardiving_txrx_set_preset(instance, name_preset, frequency, NAN, NAN, NULL, 0);
    if(instance->transmitter) {
...
bool subghz_wardiving_txrx_gen_secplus_v1_protocol(
    SubGhzTxRxWarDiving* instance,
    const char* name_preset,
    uint32_t frequency) {
    furi_assert(instance);
...
bool subghz_wardiving_txrx_gen_phoenix_v2_protocol(
    void* context,
    const char* preset_name,
    uint32_t frequency,
    uint32_t serial,
...
void subghz_wardiving_txrx_gen_serial_gangqi(uint64_t* result_key) {
...
void subghz_wardiving_txrx_gen_key_marantec(uint64_t* result_key) {
    uint64_t randkey = (uint64_t)rand();
